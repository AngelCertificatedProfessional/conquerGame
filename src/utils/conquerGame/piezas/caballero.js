...
export const movimientoCaballero = (row, col, item) => {
  ...
  for (let i = 1; i < tamanoTableroLargo + 1; i++) {
    if (
      validaPiezaMontana(`${row + i}${numeroAAlfabeto(nCol + i)}`) ||
      validaPiezaLago(`${row + i}${numeroAAlfabeto(nCol + i)}`)
    ) {
      break;
    }
    if (
  ...
  for (let i = 1; i < tamanoTableroLargo + 1; i++) {
    if (
      validaPiezaMontana(`${row + i}${numeroAAlfabeto(nCol)}`) ||
      validaPiezaLago(`${row + i}${numeroAAlfabeto(nCol)}`)
    ) {
      break;
    }
    if (
  ...
  for (let i = 1; i < tamanoTableroLargo + 1; i++) {
    if (
      validaPiezaMontana(`${row}${numeroAAlfabeto(nCol + i)}`) ||
      validaPiezaLago(`${row}${numeroAAlfabeto(nCol + i)}`)
    ) {
      break;
    }
    if (
