...
export const movimientoCanon= (row,col,item) =>{
    ...
    if (nCol < tamanoTableroAncho- 8) {
        document.getElementById(`${row}${numeroAAlfabeto(nCol+8)}`).style.backgroundColor = colorDisparoArcher
    }
    //Oeste
    if (nCol > 8) {
        document.getElementById(`${row}${numeroAAlfabeto(nCol-8)}`).style.backgroundColor = colorDisparoArcher
    ...
    if (row < tamanoTableroLargo - 8) {
        document.getElementById(`${row+8}${numeroAAlfabeto(nCol)}`).style.backgroundColor = colorDisparoArcher
    }
    //Sur
    if (row > 8) {
        document.getElementById(`${row-8}${numeroAAlfabeto(nCol)}`).style.backgroundColor = colorDisparoArcher
    ...
    if (row > 8 && nCol < (tamanoTableroAncho- 8)) {
        document.getElementById(`${row-8}${numeroAAlfabeto(nCol+8)}`).style.backgroundColor = colorDisparoArcher
    }
    if (row > 8 && nCol > 8) {
        document.getElementById(`${row-8}${numeroAAlfabeto(nCol-8)}`).style.backgroundColor = colorDisparoArcher
    }
