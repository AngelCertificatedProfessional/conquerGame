            ...
            <div className="main-currency-table">
                ...
                <div className="currency-table--container">
                    <table>
                        ...
                        <tbody>
                            {partidas !== null && partidas.map((partidasTemp, index) => (
                                <tr key={partidasTemp._id} 
                                onClick={() => setSeleccionado(partidasTemp.numeroPartida)}
                                className={
                                    ...
                                    <td className="table__top-right">
                                        {partidasTemp.tipoJuego === 1? "Individual" : "Equipos"}
                                    </td>
                                    <td className="table__top-right table__right">
                                        {partidasTemp.jugadores.length} / {partidasTemp.cantidadJugadores}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
